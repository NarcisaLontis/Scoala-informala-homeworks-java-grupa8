...
public class Main {
    ...
    public static void main ( String[] args ) throws IllegalArgumentException {
        ...
        System.out.println ( "\nNFEV6-Define the algorithm for computing the renting price by using generic types\n\nCost per day for: "+carRentalService.getManufacturer ()+" "+carRentalService.getModel ()+" is "+
                carRentalService.getPrice () / 1000+"Euro" );

        carRentalService.getRentalCost ( cars, numberOfDays );
        System.out.println ( "Price for "+carRentalService.getManufacturer ()+" "+carRentalService.getModel ()+" rented for "+
                numberOfDays+" days"+" is: "+carRentalService.getPrice () / 1000 * numberOfDays+"Euro" );
