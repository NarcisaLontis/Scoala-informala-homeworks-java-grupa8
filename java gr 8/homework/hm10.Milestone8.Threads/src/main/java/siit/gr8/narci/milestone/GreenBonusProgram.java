...
public class GreenBonusProgram {
    ...
    private class GreenBonusProgramHistory {
        ...
        public GreenBonusProgramHistory ( String clientName, String dealershipName, String carModel ) {
    ...
    //Green Bonus Program must be able to handle multiple dealership requests at the same time (concurrently)
