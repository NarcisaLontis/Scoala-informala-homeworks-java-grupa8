...
public class Dealership implements Runnable {
...
//FEV3 - Customer can sort list based on the following: price, range per charge, horsepower
    ...
    public synchronized void dealershipRequestGreenBonus ( Customer customer, GreenBonusProgram greenBonusProgram ) {
    ...
    @Override
    public void run ( ) {
        dealershipRequestGreenBonus ( new Customer ( "Gabriela Isa", 45000, 1, "BMW",
                        "i3", true, true, true ),
                new GreenBonusProgram ( 30000, 100 ) );
    }
